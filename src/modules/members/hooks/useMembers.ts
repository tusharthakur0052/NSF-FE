  ...
  const handleAddMember = useCallback(async (newMemberData: any) => {
    try {
      ...
      const payload = {
        ...
        isWhatsAppNo: true,
        gender: newMemberData.gender ? newMemberData.gender.toLowerCase() : 'male',
        ...
        subscriptionIsActive: newMemberData.status === 'Active' || newMemberData.status === 'Expiring Soon',
        subscriptionStatus: newMemberData.status,
  ...
  const handleEditMember = useCallback(async (id: string, updatedData: any) => {
    try {
      ...
      const payload = {
        ...
        isWhatsAppNo: true,
        gender: updatedData.gender ? updatedData.gender.toLowerCase() : 'male',
        ...
        subscriptionIsActive: updatedData.status === 'Active' || updatedData.status === 'Expiring Soon',
        subscriptionStatus: updatedData.status,
        joinDate: updatedData.joinDate,
        paymentMethod: updatedData.paymentMethod || 'Cash',
